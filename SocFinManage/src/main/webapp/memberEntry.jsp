...
<div class="container col-md-5" style="padding-top: 18px;">
		<div class="card">
			<div class="card-body">
				...
				<fieldset class="form-group">
	       		<label>ID:</label>
	       		<p class="text-muted">(For User type[101-105,201-205,...,501-505], For Worker type[1001-....])</p>
	        		<input type="text" name="houseId" class="form-control" required="required" placeholder="HouseId" />
	        	</fieldset>
	        	
	       		<fieldset class="form-group">
	       		<label>Member Name:</label>
	       				<input type="text" name="memName" class="form-control" required="required" placeholder="Member Name" />
	       		</fieldset>
				...
				<fieldset class="form-group">
	       		...
	       		<label>Password:</label>
	       				<input type="password" name="password" class="form-control" placeholder="Password" id="myInput1" />
